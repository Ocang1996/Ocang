...
<body>
  ...
  <div class="info-grid">
    ...
    <div class="value">${employeeData.birthDate || '-'}</div>
  </div>
          ...
          <div className="bg-gradient-to-r from-blue-50 to-white dark:from-gray-700 dark:to-gray-800 flex items-center justify-between border-b border-gray-200 dark:border-gray-700 px-6 py-4">
            ...
            <div className="flex items-center gap-2">
              {employeeData && (
                <button
                  type="button"
                  className="bg-blue-100 dark:bg-blue-700/30 text-blue-600 dark:text-blue-300 rounded-full p-1 hover:bg-blue-200 dark:hover:bg-blue-700/50 transition-colors"
              ...
              {/* Only show Edit button if onEdit function is provided (admin/superadmin only) */}
              {onEdit && employeeData && (
                <button
                  type="button"
                ...
                <div className="flex flex-col items-center sm:items-start">
                  ...
                  <div className="flex items-center mt-4 space-x-3">
                    ...
                    >
                      ...
                      <span>{downloading ? 'Mengunduh...' : 'Unduh Biodata'}</span>
                    </button>
                  </div>
                </div>
              </div>
